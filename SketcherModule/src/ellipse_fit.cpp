...
void EllipseFit::set(vector<vector<double> > input){
    take_input(input);
}

void EllipseFit::take_input(vector<vector<double> > input){
    input_matrix = input;
}

void EllipseFit::fit(double& result_center_x, double& result_center_y, double& result_phi, double& result_width, double& result_hight){
